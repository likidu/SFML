...
struct SFML_GRAPHICS_API StencilMode
{
    ...
    ///
    /// \param theStencilFunction  Specifies the kind of test to perform against the value in the stencil buffer
    /// \param theStencilOperation Specifies how the stencil buffer is updated if the test passes
    ...
    ///
    ////////////////////////////////////////////////////////////
    StencilMode(Comparison      theStencilFunction,
                UpdateOperation theStencilOperation,
